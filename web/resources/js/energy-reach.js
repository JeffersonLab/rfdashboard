...
jlab.energyReach.loadCharts = function (url, start, end, timeUnit) {
    ...
    console.log("Just before jlab.barChart.updateChart");
...
jlab.energyReach.updateLemScanChart = function (settings) {
    ...
    console.log("In jlab.energyReach.updateLemScanChart");
    console.log("url: " + url);
...
$(function () {
    console.log("energyReachUrl: " + jlab.energyReachUrl + " - start: " + jlab.start + " - end: " + jlab.end + " - timeUnit - " + jlab.timeUnit);
//    jlab.energyReach.loadCharts(jlab.energyReachUrl, jlab.start, jlab.end, jlab.timeUnit);
    jlab.energyReach.loadCharts(jlab.energyReachUrl, jlab.start, jlab.end, "day");
